...
public abstract class AbstractArrayStorageTest {
    ...
    public void update() {
        ...
        Assert.assertNotSame(resume1, storage.get(UUID_1));
    }
    ...
    public void save() {
        ...
        assertNotNull(storage.get(UUID_5));
        Assert.assertNotEquals(checkSize, storage.size());
    }
